...
Check the [TypeScript type definitions](https://github.com/katana-project/slicer/blob/main/script/index.d.ts) for more details about the events and their properties.
